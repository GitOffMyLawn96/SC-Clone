...
export function CTABand({ eyebrow, title, description }: CTABandProps) {
  return (
    <section className="py-20">
      <Container>
        <Reveal>
          <div className="relative overflow-hidden rounded-xl border border-white/10 bg-[linear-gradient(135deg,rgba(10,10,10,0.96),rgba(18,18,18,0.92))] p-8 shadow-[0_0_60px_rgba(252,185,0,0.04)] md:p-12">
            ...
            <div className="pointer-events-none absolute -right-20 -top-20 h-64 w-64 rounded-full bg-[var(--color-gold)]/8 blur-3xl" />
            <div className="pointer-events-none absolute -bottom-16 -left-16 h-48 w-48 rounded-full bg-[var(--color-gold)]/8 blur-3xl" />

            <p className="relative text-xs font-medium uppercase tracking-[0.3em] text-[var(--color-gold)]">
              {eyebrow}
            </p>
